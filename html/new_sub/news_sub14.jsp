				...
				<div class="g_postbox">
					<div class="gpo_text">
						<div class="gpo_ct">
							<div class="ct">
								<div class="ct_title">
									<span class="gtitle">1,800원으로 맛보는 호미빙 밀크티</span>
								</div>
								<div class="ct_date">
									<span class="g_15">2015.11.20</span>
								</div>
								<div class="ct_ttext">
									<p class="gmmemo">
									호미빙티에서는 오리지날 대만 밀크티를 1,800원에 판매하고 있습니다.
									<br/>
									바삭한 또띠아와 고소한 인절미의 만남 
									<br/>
									<br/>
									커피보다도 저렴한 금액 하지만 그 맛은 타의 추종을 불허합니다. 대만에서만 맛볼 수 있었던 정통 밀크티의 맛. 이젠 가격도 저렴한 호미빙티에서 부담없이 즐기세요.	

									</p>	
								</div>
								<div class="ct_last">
									<span class="gmmin_title">#ORIGINAL MILK TEA</span>
								</div>
							</div>
							<div class="ci_img">
								<img src="/homibing/lib/images/sunkyung/news-4-1-1.png"alt="" />
							</div>					
						</div>
					</div>
