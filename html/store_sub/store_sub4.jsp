...
<style>
		...
		.infoname .infotitle5{background:#333; color:#FFF;}
		...
		<div class="storcontent">
			<div class="storbox">
				...
				<div class="stor_shop_su1">
					...
					<span>홍천본점</span>
					<br/>
					<p>강원도 홍천군 홍천읍 희망리 331-6 1층 호미빙티&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;070-4233-9879&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AM09:00 - PM 11:00</p>
					<button class="infomap1 storeView" type="button" onclick="map(37.6902938, 127.8809529,'store-map1')">지도보기</button>
