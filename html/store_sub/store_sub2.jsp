...
<style>
		...
		.infoname .infotitle3{background:#333; color:#FFF;}
		...
		<div class="storcontent">
			<div class="storbox">
				...
				<div class="stor_shop_su1">
					...
					<span>인천 작전점</span>
					<br/>
					<p>인천광역시 계양구 작전동 911-7 거승프라자 2층 호미빙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;032-551-1860&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AM 11:00 ~ PM 11:00</p>
					<button class="infomap1 storeView" type="button" onclick="map(37.5309615, 126.7378254,'store-map1')">지도보기</button>
				...
				<div class="stor_shop_su2">
					...
					<span>인천 운서점</span>
					<br/>
					<p>인천 중구 운서동 2804-3 201,202호 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;032-752-1237&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AM 11:00 ~ PM 10:00</p>
					<button class="infomap1 storeView" type="button" onclick="map(37.4940560, 126.4926583,'store-map2')">지도보기</button>
					<button class="infomap1 storeClose" type="button" >지도닫기</button>
				...
				<div class="stor_shop_su3">
					...
					<span>인천청라점</span>
					<br/>
					<p>인천광역시 서구 중봉대로586번길 19 2층 호미빙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;032-561-9936</p>
					<button class="infomap1 storeView" type="button" onclick="map(37.5321063, 126.6520380,'store-map3')">지도보기</button>
					<button class="infomap1 storeClose" type="button" >지도닫기</button>
